...
<body class="bg-gray-100 min-h-screen">
    <div class="container mx-auto px-4 py-8">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-8">Créer une nouvelle activité</h1>

        <form action="/activities/store" method="POST" class="bg-white rounded-lg shadow-md p-6">
            <div class="space-y-6">
                <div>
