...
<body class="bg-gray-100 min-h-screen">
    <div class="container mx-auto px-4 py-8">
        <a href="/activities" class="inline-flex items-center text-gray-600 hover:text-gray-800 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex gap-4">
                <?php if ($isAdmin): ?>
                    ...
                    <form action="/activities/delete/<?= $activity['id'] ?>" method="POST" class="inline-block"
